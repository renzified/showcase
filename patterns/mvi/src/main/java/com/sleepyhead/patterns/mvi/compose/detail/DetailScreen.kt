package com.sleepyhead.patterns.mvi.compose.detail
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { store.dispatch(DetailIntent.NavigateBack) }) {
                        Icon(Icons.AutoMirrored.Filled.ArrowBack, contentDescription = "Back")
                    }
                },
                actions = {
                    if (instrument != null) {
                        IconButton(onClick = { store.dispatch(DetailIntent.ToggleFavorite) }) {
                            Icon(
        ...
        when {
            ...
            instrument != null -> {
                ...
                Column(
                    ...
                    Button(
                        onClick = { store.dispatch(DetailIntent.ToggleFavorite) },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(top = 16.dp),
                    ) {
